...
{
#pragma region 오버플로우
	// 특정한 자료형이 표현할 수 있는 최댓값의 범위를 벗어넘어서 연산을 수행하는 과정입니다. 
...
#pragma region 조건문(if~ else if ~else)
	// if 문: 어떤 특정한 조건을 비교하여 조건이 맞다면 실행되는 명령문입니다.

	// 만약에~ (조건)
	//if (15 == 15)
	//{
	//	printf("15는 15와 같다.\n");		// 조건이 "참"이라면 { } 내부에 있는 내용을 실행한다,
	//}
	
	// else if 문 : if문의 조건이 틀릴때 else if문의 조건이 맞다면 실행되는 명령문입니다. 
